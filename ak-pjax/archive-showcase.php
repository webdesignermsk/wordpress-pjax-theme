<?php /* Showcase ARCHIVE PAGE */ ?>
<?php get_header(); ?>
    <div id="app-wrapper" role="main">
        <div id="app" class="app-container" data-namespace="blog-archive">
            <?php query_posts('post_type=showcase&post_status=publish&posts_per_page=12&paged='. get_query_var('paged')); ?>
            ...
            <?php if( have_posts() ): ?>
                ...
                <div class="container blog-archive">
                    <div class="row txt--center blog-archive__header">
                        <h1 class="col-lg-10 col-md-12 offset-lg-1 offset-md-0 title"><?php _e('Showcase','blank-theme'); ?></h1>
                        <?php
                        $showcase_txt = get_field('showcase_text','option');
                        if($blog_txt){
                        ?>
                            <p class="col-lg-10 col-md-12 offset-lg-1 offset-md-0 txt--sm">
                                <?php echo $showcase_txt; ?>
                            </p>
                        <?php
                        }
                        ?>
